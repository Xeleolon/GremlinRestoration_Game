...
public class LevelEditorManager : EditorWindow //The Editor Window for snapping object to each other
{
    ...
    void OnGUI()
    {
        ...
        selectMovingFirst = EditorGUILayout.Toggle("Select Moving First", selectMovingFirst);
            ...
            if (Selection.transforms.Length >= 2 && Selection.gameObjects[0] != null && Selection.gameObjects[1] != null)
             {
                ...
                if (!changeMove)
                {
                    moveObject = Selection.gameObjects[1];
                }
            }
            else if (Selection.transforms.Length >= 1 && Selection.gameObjects[0] != null)
            {
    ...
    void SnapAlongX()
    {
        ...
        if (GUILayout.Button("Snap Red Forward"))
        {
            float height = 0;
            if (movingData != null)
            {
            ...
            SnapStraight(new Vector3(0.75f, 0.75f + height, 0), new Vector3(0.75f, -0.75f, 0));
        }
        

        if (GUILayout.Button("Snap Red Backwards"))
        {
            float height = 0;
            if (movingData != null)
            {
    ...
    void SnapAlongZ()
    {
        if (GUILayout.Button("Snap Blue Left"))
        {
            float height = 0;
            if (movingData != null)
            {
            ...
            SnapStraight(new Vector3(0, 0.75f + height, 0.75f), new Vector3(0, -0.75f, 0.75f));
        }
        

        if (GUILayout.Button("Snap Blue Right"))
        {
            float height = 0;
            if (movingData != null)
            {
